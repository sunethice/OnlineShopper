                ...
                <div class="col-md-3">
                    <div class="row mb-3 mt-3 mr-2">
                        <div class="form-inline mr-auto mb-3">
                            <label class="font-weight-bold mb-2" for="formName"
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div
                            ...
                            :key="index"
                            v-if="product.price <= Number(prodPrice)"
                        >
                            ...
                            <div class="card mb-3 mt-3 product-card-rounded">
                                <div class="row no-gutters">
                                    <div class="col">
                                        <div
                                            class="card-header excursion-header"
                                        >
                                            <img
                                                width="100%"
                                                height="100%"
                                        ...
                                        <div class="card-footer product-footer">
                                            <p
                                                class="px-3 pt-3 float-left product-name"
                                                v-html="product.product_name"
                                            ></p>
                                            <p
                                                class="px-3 py-1 float-left product-price"
                                            >
                                                $ {{ product.price }}
                                            </p>
                                            <button
                                                class="btn btn-info float-right product-btn"
